(function ($, wp) {
    ...
    $(document).ready(function () {
        var button_select = $('.sp-media__select'),
            button_clear = $('.sp-media__clear'),
            media_frame;
        ...
        button_select.live('click', function (e) {
            ...
            media_frame.on('select', function () {
                ...
                container.find('.sp-media__clear').show();
        ...
        button_clear.live('click', function () {
            ...
            $(this).parents('.uploader').find('input').change();
            $(this).parents('.uploader').find('.image-preview').html('');
            $(this).hide();
        });
    });
